...
int main() {
	...
	AbstractionAwithImB.introduce(); // Hi, I'm Linda Taylor I can [Walk & Run & Swim]
	AbstractionBwithImB.exercise(); // Linda Taylor does the following exercices: [Walk & Run & Swim]
